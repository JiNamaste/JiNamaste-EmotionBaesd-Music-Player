...
def after():
     ...
     return render_template("after.html", data=prediction, link=link)


@app.route('/after1',methods=['GET','POST'])
def after1():
     ...
     cap.release()
     link  = f"https://www.youtube.com/results?search_query={prediction}+song"
     webbrowser.open(link)
